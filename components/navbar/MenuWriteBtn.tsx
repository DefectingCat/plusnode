    ...
    <>
      <div className="px-1 mb-3">
        <Link href="/" passHref>
          <a
            className={cn(
              'flex items-center justify-center px-4 py-3 shadow',
              'font-semibold tracking-wide text-white uppercase rounded-lg',
              'bg-brand-blue hover:bg-opacity-75 hover:shadow-none'
            )}
          >
            <svg className="w-6 h-6 mr-3 fill-current" viewBox="0 0 512 512">
